...
{
    [Table("ZREPEATTRANSACTION")]
    public partial class ZRepeatTransaction
    {
        [Key]
        [Column("Z_PK")]
        ...
        [Column("ZNEXTDATE")]
        public long? ZNextDate { get; set; }

        [Column("ZREPEATTYPE")]
        public long? ZRepeatType { get; set; }
        ...
        [Column("ZTZ_NAME", TypeName = "VARCHAR")]
        public string ZTzName { get; set; }

        [Column("ZTZ_OFFSET", TypeName = "VARCHAR")]
        public string ZTzOffset { get; set; }
